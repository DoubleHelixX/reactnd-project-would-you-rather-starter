...
export default function TitleAnimate() {
  ...
  if (title.length > 0) {
    setTimeout(() => {
      ...
      title[0].style["text-shadow"] =
        "1px 1px 0 #000000, 1px -1px 0 #000000, -1px 1px 0 #000000, -1px -1px 0 #000000, 1px 0px 0 #000000, 0px 1px 0 #000000, -1px 0px 0 #000000, 0px -1px 0 #000000";
      ...
      questionMarks[0].style["text-shadow"] =
        "1px 1px 0 #000000, 1px -1px 0 #000000, -1px 1px 0 #000000, -1px -1px 0 #000000, 1px 0px 0 #000000, 0px 1px 0 #000000, -1px 0px 0 #000000, 0px -1px 0 #000000";
    }, 250);
    ...
    setTimeout(() => {
      ...
      questionMarks[1].style["text-shadow"] =
        "1px 1px 0 #000000, 1px -1px 0 #000000, -1px 1px 0 #000000, -1px -1px 0 #000000, 1px 0px 0 #000000, 0px 1px 0 #000000, -1px 0px 0 #000000, 0px -1px 0 #000000";
    }, 500);
    ...
    setTimeout(() => {
      ...
      questionMarks[2].style["text-shadow"] =
        "1px 1px 0 #000000, 1px -1px 0 #000000, -1px 1px 0 #000000, -1px -1px 0 #000000, 1px 0px 0 #000000, 0px 1px 0 #000000, -1px 0px 0 #000000, 0px -1px 0 #000000";
    }, 750);
    ...
    setTimeout(() => {
      ...
      signature[0].textContent =
        " (React/Redux App)  Created By: Tommy Rivera ";
      signature[0].style["text-shadow"] =
        "1px 1px 0 #000000, 1px -1px 0 #000000, -1px 1px 0 #000000, -1px -1px 0 #000000, 1px 0px 0 #000000, 0px 1px 0 #000000, -1px 0px 0 #000000, 0px -1px 0 #000000";
    }, 950);
  }
