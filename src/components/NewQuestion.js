  ...
  render() {
    ...
    return (
      <div className="new-question-container">
        <h1 className="n-q-c-header">Create New Question</h1>

        <p className="n-q-c-hint">Complete the question below:</p>

        <h2 className="n-q-c-phrase">Would you Rather ..</h2>
        <form
          onSubmit={(event) => this.handleQuestion(event)}
          className="n-q-c-form"
        >
